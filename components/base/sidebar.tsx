  ...
  return (
    ...
    > 
      ...
      <div className="flex flex-col h-16 justify-center px-6 border-b border-gray-100 dark:border-gray-700">
        <h1 
          className="text-xl font-bold text-gray-900 dark:text-white font-serif tracking-tight leading-none"
          style={whiteStyle}
        >
          Gutmann
        </h1>
        <div 
          className="text-xs tracking-[0.1em] uppercase text-gray-700 dark:text-white mt-0.5"
          style={whiteStyle}
        >
          Concierge
        </div>
      ...
      <div className="px-6 py-6 flex justify-center">
        ...
        >
          ...
          {/* DER CONCIERGE TEXT UNTER DER GLOCKE */}
          <span 
